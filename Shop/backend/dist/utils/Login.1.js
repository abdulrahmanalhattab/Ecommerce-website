...
function Login(req, res) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if ((yield User_1.default.findOne({ email: _Email, password: _Password })) !== null)
            return { status: false, msg: "Email or password incorrect. " };
        const _Token = yield token_1.default.findOne({ email: _Email }, { _id: 0, token: 1 });
        const _NewSession = yield (0, new_session_1.NewSession)(_Email, (_a = _Token === null || _Token === void 0 ? void 0 : _Token.token) !== null && _a !== void 0 ? _a : "");
        if (_NewSession.status === false)
            return _NewSession;
        return {
            status: _NewSession.status,
            data: {
